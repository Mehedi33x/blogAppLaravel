    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            <div class="mainheading">
                <h1 class="posttitle">{{ $post_details->title ?? ""}}</h1>
            </div>
            {{-- <img class="featured-image img-fluid" src="{{ url('frontend/assets/img/demopic/10.jpg/') }}" alt=""> --}}
            <img class="featured-image img-fluid" src="{{ $post_details->image ?? ""}}" alt="" style="width: 730px; height: 486px;">
            ...
            {{-- a section writing comment and display those comment  --}}
            ...
            <div class="row post-top-meta">
                ...
                <div class="col-md-10">
                    <a class="link-dark" href="author.html">{{$post_details->user->name ?? ""}}</a><a href="#" class="btn follow">Follow</a>
                    <span class="author-description">Founder of WowThemes.net and creator of <b>"Mediumish"</b> theme
                        that you're currently previewing. Developing professional premium themes, templates, plugins,
            ...
            <div class="comment-section mt-5">
                ...
                <form action="{{ route('post.comment', $post_details->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <textarea class="form-control" id="comment" name="comment" rows="5" placeholder="Write your comment here"
                            required></textarea>
                    </div>
                ...
                <div class="mt-5">
                    <h3>Comments</h3>
                    @if ($post_details->comments->isEmpty())
